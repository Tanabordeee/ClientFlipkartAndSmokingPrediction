...
export default function SvmPredictForm(){
    ...
    return (
        <>
        <h1 className="text-5xl m-5 font-bold">Support Vector Regression</h1>
        <form onSubmit={SvmPredict} className="flex flex-col gap-5 border w-[50%] p-5 mt-5 rounded-lg">
            <label>PRICE</label>
            <input type="text" 
