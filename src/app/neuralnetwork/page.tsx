    ...
    <div className="flex flex-col justify-center items-center mt-5 gap-5 m-5">
      ...
      <div className="w-[50%] p-10 border shadow-lg rounded-xl text-center bg-white m-5">
        ...
        <div className="flex flex-col items-center justify-center mb-5">
          ...
          />
          <Image
            src={"https://img5.pic.in.th/file/secure-sv1/Screenshot-2025-02-21-213526.png"}
        ...
        <p className="text-lg mb-5">
          หลังจากนั้นผมก็โหลด Model MobileNetV2 โดยมี pre-trained weights และตัดชั้น Fully Connected ออก กำหนดขนาด input เป็นภาพ 224 x 224 pixels และ 3 คือ RGB 
         โดยจะมีการ Freeze Layers ของ MobileNetV2 จะทำให้แค่ดึง Feature จากภาพ แต่จะไม่ถูกปรับค่า Weight ในการ Train จากนั้นสร้างโมเดลโดยเพิ่ม Layer ใหม่ 
         ใช้ Global Average Pooling เพื่อแปลง Feature Map ของ MobileNetV2 ให้เป็นเวกเตอร์เดียว และใช้ Dense Layer 1 นิวรอน พร้อมกับ Sigmoid Activation 
         เพื่อจำแนกข้อมูลออกเป็น 2 คลาส หลังจากนั้นก็คอมไพล์โมเดล โดยใช้ Adam Optimizer เป็นตัวปรับค่าถ่วงน้ำหนักของโมเดล และใช้ Binary Crossentropy Loss 
         เนื่องจากเป็นปัญหาจำแนกสองคลาส และผมก็ได้สร้าง EarlyStopping เพื่อลด Overfitting โดยหยุดการฝึกเมื่อค่า val_loss ไม่ลดลงติดต่อกัน 5 รอบ และใช้ restore_best_weights=True 
         เพื่อย้อนคืนค่า Weight ที่ดีที่สุดก่อน Overfitting จากนั้นก็ฝึกโมเดล 🧠
        </p>
        <div className="flex justify-center mb-5">
          <Image
            src={"https://img2.pic.in.th/pic/Screenshot-2025-02-21-213114.png"}
            className="rounded-lg"
            width={600}
            height={400}
            alt="VGG16"
